...
def penalize_out_scope_errors(y_true:List[int], y_pred:List[int], label_dict:Dict[str, int]) -> float:
...
def penalize_luggage_lost_errors(y_true:List[int], y_pred:List[int], label_dict:Dict[str, int]) -> float:
